<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
        <form class="search-form d-flex align-items-center" method="POST" action="#">
            <input type="text" name="query" placeholder="{{ __('layout_master.search') }}"
        ...
        <ul class="d-flex align-items-center">
            ...
            <div class="dropdown">
                <a class="btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                    {{ __('layout_master.language') }}
                </a>

                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="min-width: 112px !important;">
                    <li><a class="dropdown-item" href="{{ route('setLang', ['locale' => 'en']) }}">English</a></li>
                    <li><a class="dropdown-item" href="{{ route('setLang', ['locale' => 'vn']) }}">VietNam</a></li>
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('users.show', ['user' => Auth::id()]) }}">
                            ...
                            <span>{{ __('layout_master.my_profile') }}</span>
                        </a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    ...
                    <li>
                        <button id="show-setting" class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                            ...
                            <span>{{ __('layout_master.account_settings') }}</span>
                        </button>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            ...
                            <span>{{ __('layout_master.need_help') }}</span>
                        </a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
