...
<form method="post" action="{{ route('users.store') }}">
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>{{ __('layout_master.create') }}</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="\dashboard">{{ __('layout_master.home') }}</a></li>
                    <li class="breadcrumb-item active"><a href="\users">{{ __('layout_master.users') }}</a> / {{ __('layout_master.create') }}</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            <div class="col-xxl-4 col-md-12">
                <div class="card info-card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">{{ __('layout_master.users') }} <span>| {{ __('layout_master.create') }}</span></h5>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control phone_input" name="phone_number"
                                        placeholder="Ex: 123456789" value="{{ old('phone_number') }}">
                                </div>
                                @error('phone_number')
                                <div class="invalidate">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10 row">
                                ...
                                <div class="col-sm-4">
                                    <label class="col-form-label">{{ __('layout_user.role') }}</label>
                                    <select class="form-select" name="roles" aria-label="Default select example">
                                        ...
                                        <option value="{{ $role }}" style="display: {{ $role }}">
                                            {{ $role }}</option>
